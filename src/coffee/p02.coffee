...
update = ->
  ...
  document.getElementById("message").innerHTML = " Have a nice day! - 1"  if keyboard.pressed("1")
  document.getElementById("message").innerHTML = " Have a nice day! - 2 "  if keyboard.pressed("2")
  controls.update()
  stats.update()
  return
